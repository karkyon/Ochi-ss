...
namespace Ochi_ss
{
    public partial class OrderSearch : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    ...
                    // レコード取得
                    var dt = gCls.GetDataTable(con, "usp_ASP_OrderSearchLiteList_get", sqlParams);
        ...
        protected void OrderList_PagePropertiesChanged(object sender, EventArgs e)
        {
        ...
        protected void OrderList_ItemUpdated(object sender, ListViewUpdatedEventArgs e)
        {
        ...
        protected void BtnLoadEditEstOrder_Click(object sender, EventArgs e)
        {
            ...
            // 見積No
            Label estNo = ((Label)OrderList.Items[index].FindControl("lblEstNo"));
