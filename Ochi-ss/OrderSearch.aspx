<%@ Page Language="C#" MasterPageFile="~/MasterPages/Ochi-ss.Search.Master" AutoEventWireup="true" CodeBehind="OrderSearch.aspx.cs" Inherits="Ochi_ss.OrderSearch" %>

<asp:Content ID="ContentHeader" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="ContentMain" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <form id="form1" runat="server" style="display: inline-block; text-align: left;">    
    ...
    <asp:ListView ID="OrderList" runat="server" 
        OnItemUpdated="OrderList_ItemUpdated"
        OnPagePropertiesChanged="OrderList_PagePropertiesChanged">
        ...
        <EmptyDataTemplate>
            <div class="header-area">
                ...
                <thead>
                    ...
                    <td colspan="1" rowspan="1" runat="server" class="multi free tlbl col-edit-btn">複製</td>
                    </tr>
        ...
        <LayoutTemplate>
            <div class="header-area">
              <table id="OrderList" class="multi">
                <thead>
                  <tr>
                    <td colspan="1" rowspan="1" runat="server" class="multi free tlbl col-estimate-no">見積No</td>
                    <td colspan="1" rowspan="1" runat="server" class="multi free tlbl col-estimate-date">見積日付</td>            
